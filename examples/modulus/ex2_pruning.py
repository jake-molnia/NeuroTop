...
def main(modulus, prune_cycles, finetune_epochs, train_epochs,
         ...
         max_samples, max_prune_fraction, pruning_method, alpha, beta, gamma,
    ...
    console.print(
        f"[dim]p={modulus}  method={pruning_method}  cycles={prune_cycles}  max_prune={max_prune_fraction:.1%}"
